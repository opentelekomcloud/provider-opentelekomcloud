...
The OpenTelekomCloud Terraform provider exposes many resources, but not all of them are properly implemented in our Crossplane provider. You can track the implementation status of OTC services in this [issue](https://github.com/opentelekomcloud/provider-opentelekomcloud/issues/7).  
...
> [!NOTE]
> For this to work you need to have crossplane core already deployed in your cluster. Crossplane will use your locally running provider as it's OpenTelekomCloud operator.
```console
make run
```
