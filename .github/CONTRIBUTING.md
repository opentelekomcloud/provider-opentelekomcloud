...
The [Terraform T Cloud Public](https://github.com/opentelekomcloud/terraform-provider-opentelekomcloud) exposes many resources, but not all of them are properly configured in our Crossplane provider. You can track the implementation status of T Cloud Public services in this [issue](https://github.com/opentelekomcloud/provider-opentelekomcloud/issues/7).  
...
> [!NOTE]
> For this to work you need to have crossplane core already [deployed](https://docs.crossplane.io/latest/get-started/install/) in your cluster. Crossplane will use your locally running provider as it's T Cloud Public operator.
```console
make run
```
