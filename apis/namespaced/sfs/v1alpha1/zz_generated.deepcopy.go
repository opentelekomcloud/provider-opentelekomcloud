...
func (in *AccessRuleInitParameters) DeepCopyInto(out *AccessRuleInitParameters) {
	*out = *in
	...
	if in.AccessToRef != nil {
		in, out := &in.AccessToRef, &out.AccessToRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.AccessToSelector != nil {
		in, out := &in.AccessToSelector, &out.AccessToSelector
...
func (in *ShareAccessRulesV2InitParameters) DeepCopyInto(out *ShareAccessRulesV2InitParameters) {
	*out = *in
	...
	if in.ShareSelectorRef != nil {
		in, out := &in.ShareSelectorRef, &out.ShareSelectorRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *TurboShareV1InitParameters) DeepCopyInto(out *TurboShareV1InitParameters) {
	*out = *in
	...
	if in.SecgroupSelector != nil {
		in, out := &in.SecgroupSelector, &out.SecgroupSelector
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.SecgroupSelectorRef != nil {
		in, out := &in.SecgroupSelectorRef, &out.SecgroupSelectorRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.SubnetSelectorRef != nil {
		in, out := &in.SubnetSelectorRef, &out.SubnetSelectorRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.VPCID != nil {
	...
	if in.VPCSelectorRef != nil {
		in, out := &in.VPCSelectorRef, &out.VPCSelectorRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
}
