...
type CheckpointV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/dis/v1alpha1.AppV2
	...
	AppNameRef *v1.NamespacedReference `json:"appNameRef,omitempty" tf:"-"`

	// Selector for a AppV2 in dis to populate appName.
	// +kubebuilder:validation:Optional
	AppNameSelector *v1.NamespacedSelector `json:"appNameSelector,omitempty" tf:"-"`
