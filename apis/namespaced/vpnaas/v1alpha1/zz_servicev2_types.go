...
type ServiceV2InitParameters struct {
	...
	// The administrative state of the resource. Can either be true (Up) or false (Down).
...
// ServiceV2 is the Schema for the ServiceV2s API. Manages a VPNAAS Service resource within OpenTelekomCloud.
