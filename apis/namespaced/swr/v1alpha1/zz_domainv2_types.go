...
type DomainV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/swr/v1alpha1.OrganizationV2
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/swr/v1alpha1.RepositoryV2
