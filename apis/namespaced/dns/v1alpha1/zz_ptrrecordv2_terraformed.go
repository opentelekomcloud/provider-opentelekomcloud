...
func (mg *PtrrecordV2) GetTerraformResourceType() string {
	return "opentelekomcloud_dns_ptrrecord_v2"
}
...
func (tr *PtrrecordV2) GetObservation() (map[string]any, error) {
...
func (tr *PtrrecordV2) SetObservation(obs map[string]any) error {
...
func (tr *PtrrecordV2) GetParameters() (map[string]any, error) {
...
func (tr *PtrrecordV2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this PtrrecordV2
func (tr *PtrrecordV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PtrrecordV2
func (tr *PtrrecordV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this PtrrecordV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PtrrecordV2) LateInitialize(attrs []byte) (bool, error) {
	params := &PtrrecordV2Parameters{}
