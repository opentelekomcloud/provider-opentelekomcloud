...
func (mg *VolumeV2) GetTerraformResourceType() string {
	return "opentelekomcloud_blockstorage_volume_v2"
}
...
func (tr *VolumeV2) GetObservation() (map[string]any, error) {
...
func (tr *VolumeV2) SetObservation(obs map[string]any) error {
...
func (tr *VolumeV2) GetParameters() (map[string]any, error) {
...
func (tr *VolumeV2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this VolumeV2
func (tr *VolumeV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeV2
func (tr *VolumeV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
