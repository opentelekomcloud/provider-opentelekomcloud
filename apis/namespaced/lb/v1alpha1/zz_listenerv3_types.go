...
type IPGroupInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/lb/v1alpha1.IpgroupV3
...
type ListenerV3InitParameters struct {
	...
	// +kubebuilder:validation:Optional
	DefaultTLSContainerRefRef *v1.NamespacedReference `json:"defaultTlsContainerRefRef,omitempty" tf:"-"`

	// Selector for a CertificateV3 in lb to populate defaultTlsContainerRef.
	// +kubebuilder:validation:Optional
	DefaultTLSContainerRefSelector *v1.NamespacedSelector `json:"defaultTlsContainerRefSelector,omitempty" tf:"-"`
