...
type BandwidthAssociateV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/vpc/v1alpha1.BandwidthV2
	...
	BandwidthRef *v1.NamespacedReference `json:"bandwidthRef,omitempty" tf:"-"`

	// Selector for a BandwidthV2 in vpc to populate bandwidth.
	// +kubebuilder:validation:Optional
	BandwidthSelector *v1.NamespacedSelector `json:"bandwidthSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	FloatingIpsRefs []v1.NamespacedReference `json:"floatingIpsRefs,omitempty" tf:"-"`

	// Selector for a list of EIPV1 in vpc to populate floatingIps.
	// +kubebuilder:validation:Optional
	FloatingIpsSelector *v1.NamespacedSelector `json:"floatingIpsSelector,omitempty" tf:"-"`
}
