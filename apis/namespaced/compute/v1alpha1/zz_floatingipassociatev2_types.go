...
type FloatingipAssociateV2InitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/networking/v1alpha1.FloatingipV2
...
// FloatingipAssociateV2 is the Schema for the FloatingipAssociateV2s API. Manages an EIP Associate resource within OpenTelekomCloud.
