...
type InstanceV2InitParameters struct {
	...
	AdminPassSecretRef *v1.LocalSecretKeySelector `json:"adminPassSecretRef,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced/compute/v1alpha1.KeypairV2
	...
	SSHPrivateKeyPathSecretRef *v1.LocalSecretKeySelector `json:"sshPrivateKeyPathSecretRef,omitempty" tf:"-"`
