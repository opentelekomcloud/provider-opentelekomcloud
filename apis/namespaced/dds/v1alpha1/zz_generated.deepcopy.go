...
func (in *PublicIPAssociateV3InitParameters) DeepCopyInto(out *PublicIPAssociateV3InitParameters) {
	*out = *in
	...
	if in.PublicIPSelectorByID != nil {
		in, out := &in.PublicIPSelectorByID, &out.PublicIPSelectorByID
		*out = new(v1.NamespacedSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.PublicIPSelectorByIDRef != nil {
		in, out := &in.PublicIPSelectorByIDRef, &out.PublicIPSelectorByIDRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
	if in.PublicIPSelectorRef != nil {
		in, out := &in.PublicIPSelectorRef, &out.PublicIPSelectorRef
		*out = new(v1.NamespacedReference)
		(*in).DeepCopyInto(*out)
	}
}
