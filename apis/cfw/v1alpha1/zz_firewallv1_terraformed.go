...
func (mg *FirewallV1) GetTerraformResourceType() string {
	return "opentelekomcloud_cfw_firewall_v1"
}
...
func (tr *FirewallV1) GetObservation() (map[string]any, error) {
...
func (tr *FirewallV1) SetObservation(obs map[string]any) error {
...
func (tr *FirewallV1) GetParameters() (map[string]any, error) {
...
func (tr *FirewallV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this FirewallV1
func (tr *FirewallV1) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this FirewallV1
func (tr *FirewallV1) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this FirewallV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FirewallV1) LateInitialize(attrs []byte) (bool, error) {
	params := &FirewallV1Parameters{}
