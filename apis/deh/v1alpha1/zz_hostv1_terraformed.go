...
func (mg *HostV1) GetTerraformResourceType() string {
	return "opentelekomcloud_deh_host_v1"
}
...
func (tr *HostV1) GetObservation() (map[string]any, error) {
...
func (tr *HostV1) SetObservation(obs map[string]any) error {
...
func (tr *HostV1) GetParameters() (map[string]any, error) {
...
func (tr *HostV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this HostV1
func (tr *HostV1) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this HostV1
func (tr *HostV1) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this HostV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *HostV1) LateInitialize(attrs []byte) (bool, error) {
	params := &HostV1Parameters{}
