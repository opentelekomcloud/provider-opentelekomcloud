...
type SecgroupRuleV2InitParameters struct {
	...
	// The layer 4 protocol type, valid values are following. Changing this creates a new security group rule.
...
// SecgroupRuleV2 is the Schema for the SecgroupRuleV2s API. Manages a VPC Security Group Rule resource within OpenTelekomCloud.
