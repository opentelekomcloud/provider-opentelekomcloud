...
func (mg *EndpointV1) GetTerraformResourceType() string {
	return "opentelekomcloud_vpcep_endpoint_v1"
}
...
func (tr *EndpointV1) GetObservation() (map[string]any, error) {
...
func (tr *EndpointV1) SetObservation(obs map[string]any) error {
...
func (tr *EndpointV1) GetParameters() (map[string]any, error) {
...
func (tr *EndpointV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this EndpointV1
func (tr *EndpointV1) GetInitParameters() (map[string]any, error) {
...
// LateInitialize this EndpointV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EndpointV1) LateInitialize(attrs []byte) (bool, error) {
	params := &EndpointV1Parameters{}
...
func (mg *ServiceV1) GetTerraformResourceType() string {
	return "opentelekomcloud_vpcep_service_v1"
}
...
func (tr *ServiceV1) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *ServiceV1) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this ServiceV1
...
func (tr *ServiceV1) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
func (tr *ServiceV1) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// GetInitParameters of this ServiceV1
func (tr *ServiceV1) GetInitParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.InitProvider)
	if err != nil {
		return nil, err
	}
...
// LateInitialize this ServiceV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServiceV1) LateInitialize(attrs []byte) (bool, error) {
	params := &ServiceV1Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
