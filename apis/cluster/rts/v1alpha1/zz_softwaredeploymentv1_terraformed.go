...
func (mg *SoftwareDeploymentV1) GetTerraformResourceType() string {
	return "opentelekomcloud_rts_software_deployment_v1"
}
...
func (tr *SoftwareDeploymentV1) GetObservation() (map[string]any, error) {
...
func (tr *SoftwareDeploymentV1) SetObservation(obs map[string]any) error {
...
func (tr *SoftwareDeploymentV1) GetParameters() (map[string]any, error) {
...
func (tr *SoftwareDeploymentV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this SoftwareDeploymentV1
func (tr *SoftwareDeploymentV1) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SoftwareDeploymentV1
func (tr *SoftwareDeploymentV1) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this SoftwareDeploymentV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SoftwareDeploymentV1) LateInitialize(attrs []byte) (bool, error) {
	params := &SoftwareDeploymentV1Parameters{}
