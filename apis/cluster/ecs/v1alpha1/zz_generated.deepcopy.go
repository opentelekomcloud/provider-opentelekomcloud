...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPv6BandwidthInitParameters) DeepCopyInto(out *IPv6BandwidthInitParameters) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPv6BandwidthInitParameters.
func (in *IPv6BandwidthInitParameters) DeepCopy() *IPv6BandwidthInitParameters {
	if in == nil {
		return nil
	}
	out := new(IPv6BandwidthInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPv6BandwidthObservation) DeepCopyInto(out *IPv6BandwidthObservation) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPv6BandwidthObservation.
func (in *IPv6BandwidthObservation) DeepCopy() *IPv6BandwidthObservation {
	if in == nil {
		return nil
	}
	out := new(IPv6BandwidthObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPv6BandwidthParameters) DeepCopyInto(out *IPv6BandwidthParameters) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPv6BandwidthParameters.
func (in *IPv6BandwidthParameters) DeepCopy() *IPv6BandwidthParameters {
	if in == nil {
		return nil
	}
	out := new(IPv6BandwidthParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstanceV1InitParameters) DeepCopyInto(out *InstanceV1InitParameters) {
	*out = *in
	...
	if in.OsSchedulerHints != nil {
		in, out := &in.OsSchedulerHints, &out.OsSchedulerHints
		*out = make([]OsSchedulerHintsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *InstanceV1Observation) DeepCopyInto(out *InstanceV1Observation) {
	*out = *in
	...
	if in.OsSchedulerHints != nil {
		in, out := &in.OsSchedulerHints, &out.OsSchedulerHints
		*out = make([]OsSchedulerHintsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *InstanceV1Parameters) DeepCopyInto(out *InstanceV1Parameters) {
	*out = *in
	...
	if in.OsSchedulerHints != nil {
		in, out := &in.OsSchedulerHints, &out.OsSchedulerHints
		*out = make([]OsSchedulerHintsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NicsInitParameters) DeepCopyInto(out *NicsInitParameters) {
	*out = *in
	...
	if in.IPv6Bandwidth != nil {
		in, out := &in.IPv6Bandwidth, &out.IPv6Bandwidth
		*out = make([]IPv6BandwidthInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NicsObservation) DeepCopyInto(out *NicsObservation) {
	*out = *in
	...
	if in.IPv6Bandwidth != nil {
		in, out := &in.IPv6Bandwidth, &out.IPv6Bandwidth
		*out = make([]IPv6BandwidthObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NicsParameters) DeepCopyInto(out *NicsParameters) {
	*out = *in
	...
	if in.IPv6Bandwidth != nil {
		in, out := &in.IPv6Bandwidth, &out.IPv6Bandwidth
		*out = make([]IPv6BandwidthParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OsSchedulerHintsInitParameters) DeepCopyInto(out *OsSchedulerHintsInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OsSchedulerHintsInitParameters.
func (in *OsSchedulerHintsInitParameters) DeepCopy() *OsSchedulerHintsInitParameters {
	if in == nil {
		return nil
	}
	out := new(OsSchedulerHintsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OsSchedulerHintsObservation) DeepCopyInto(out *OsSchedulerHintsObservation) {
	*out = *in
	if in.DedicatedHostID != nil {
		in, out := &in.DedicatedHostID, &out.DedicatedHostID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OsSchedulerHintsObservation.
func (in *OsSchedulerHintsObservation) DeepCopy() *OsSchedulerHintsObservation {
	if in == nil {
		return nil
	}
	out := new(OsSchedulerHintsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OsSchedulerHintsParameters) DeepCopyInto(out *OsSchedulerHintsParameters) {
	*out = *in
	if in.DedicatedHostID != nil {
		in, out := &in.DedicatedHostID, &out.DedicatedHostID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OsSchedulerHintsParameters.
func (in *OsSchedulerHintsParameters) DeepCopy() *OsSchedulerHintsParameters {
	if in == nil {
		return nil
	}
	out := new(OsSchedulerHintsParameters)
	in.DeepCopyInto(out)
	return out
}
