...
func (mg *SnapshotConfigurationV1) GetTerraformResourceType() string {
	return "opentelekomcloud_css_snapshot_configuration_v1"
}
...
func (tr *SnapshotConfigurationV1) GetObservation() (map[string]any, error) {
...
func (tr *SnapshotConfigurationV1) SetObservation(obs map[string]any) error {
...
func (tr *SnapshotConfigurationV1) GetParameters() (map[string]any, error) {
...
func (tr *SnapshotConfigurationV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this SnapshotConfigurationV1
func (tr *SnapshotConfigurationV1) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SnapshotConfigurationV1
func (tr *SnapshotConfigurationV1) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this SnapshotConfigurationV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SnapshotConfigurationV1) LateInitialize(attrs []byte) (bool, error) {
	params := &SnapshotConfigurationV1Parameters{}
