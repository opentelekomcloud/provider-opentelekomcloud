...
func (tr *InstanceV2) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"admin_pass": "adminPassSecretRef", "encrypted_password": "status.atProvider.encryptedPassword", "password": "status.atProvider.password", "ssh_private_key_path": "sshPrivateKeyPathSecretRef"}
}
