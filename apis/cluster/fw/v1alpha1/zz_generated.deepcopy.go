...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FirewallGroupV2InitParameters) DeepCopyInto(out *FirewallGroupV2InitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FirewallGroupV2InitParameters.
func (in *FirewallGroupV2InitParameters) DeepCopy() *FirewallGroupV2InitParameters {
	if in == nil {
		return nil
	}
	out := new(FirewallGroupV2InitParameters)
	in.DeepCopyInto(out)
	return out
}
