...
func (tr *FunctionV2) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"encrypted_user_data": "encryptedUserDataSecretRef"}
}
...
// GetInitParameters of this FunctionV2
func (tr *FunctionV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
