...
func (mg *DomainV2) GetTerraformResourceType() string {
	return "opentelekomcloud_swr_domain_v2"
}
...
func (tr *DomainV2) GetObservation() (map[string]any, error) {
...
func (tr *DomainV2) SetObservation(obs map[string]any) error {
...
func (tr *DomainV2) GetParameters() (map[string]any, error) {
...
func (tr *DomainV2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this DomainV2
func (tr *DomainV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DomainV2
func (tr *DomainV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this DomainV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DomainV2) LateInitialize(attrs []byte) (bool, error) {
	params := &DomainV2Parameters{}
