...
func (mg *ImageAccessAcceptV2) GetTerraformResourceType() string {
	return "opentelekomcloud_images_image_access_accept_v2"
}
...
// LateInitialize this ImageAccessAcceptV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ImageAccessAcceptV2) LateInitialize(attrs []byte) (bool, error) {
	params := &ImageAccessAcceptV2Parameters{}
...
func (mg *ImageAccessV2) GetTerraformResourceType() string {
	return "opentelekomcloud_images_image_access_v2"
}
...
// LateInitialize this ImageAccessV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ImageAccessV2) LateInitialize(attrs []byte) (bool, error) {
	params := &ImageAccessV2Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
func (mg *ImageV2) GetTerraformResourceType() string {
	return "opentelekomcloud_images_image_v2"
}
