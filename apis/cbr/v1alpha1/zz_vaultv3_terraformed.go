...
func (mg *VaultV3) GetTerraformResourceType() string {
	return "opentelekomcloud_cbr_vault_v3"
}
...
func (tr *VaultV3) GetObservation() (map[string]any, error) {
...
func (tr *VaultV3) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this VaultV3
...
func (tr *VaultV3) GetParameters() (map[string]any, error) {
...
func (tr *VaultV3) SetParameters(params map[string]any) error {
...
// GetInitParameters of this VaultV3
func (tr *VaultV3) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VaultV3
func (tr *VaultV3) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this VaultV3 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *VaultV3) LateInitialize(attrs []byte) (bool, error) {
	params := &VaultV3Parameters{}
