...
type IpsecPolicyV2InitParameters struct {
	...
	// The encapsulation mode. Default is tunnel.
	...
	// The perfect forward secrecy mode. Valid values are group1, group2, group5, group14,
	...
	// The transform protocol. Valid values are esp, ah and ah-esp. Default is esp.
...
// IpsecPolicyV2 is the Schema for the IpsecPolicyV2s API. Manages a VPNAAS IPSEC Policy resource within OpenTelekomCloud.
