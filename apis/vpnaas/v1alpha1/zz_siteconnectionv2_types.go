...
type SiteConnectionV2InitParameters struct {
	...
	// The administrative state of the resource. Can either be up(true) or
	...
	// An ID to be used instead of the external IP address for a virtual router used in
	...
	// The peer router identity for authentication. A valid value is an IPv4 address,
