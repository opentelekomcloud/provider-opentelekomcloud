...
type IkePolicyV2InitParameters struct {
	...
	// The authentication hash algorithm. Valid values are md5,
	...
	// The perfect forward secrecy mode. Valid values are group1, group2, group5 and so on.
	// Default is group5.
...
// IkePolicyV2 is the Schema for the IkePolicyV2s API. Manages a VPNAAS IKE Policy resource within OpenTelekomCloud.
