...
func (mg *RepositoryV2) GetTerraformResourceType() string {
	return "opentelekomcloud_swr_repository_v2"
}
...
func (tr *RepositoryV2) GetObservation() (map[string]any, error) {
...
func (tr *RepositoryV2) SetObservation(obs map[string]any) error {
...
func (tr *RepositoryV2) GetParameters() (map[string]any, error) {
...
func (tr *RepositoryV2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this RepositoryV2
func (tr *RepositoryV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RepositoryV2
func (tr *RepositoryV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this RepositoryV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RepositoryV2) LateInitialize(attrs []byte) (bool, error) {
	params := &RepositoryV2Parameters{}
