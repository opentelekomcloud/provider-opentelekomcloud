...
func (mg *OrganizationV2) GetTerraformResourceType() string {
	return "opentelekomcloud_swr_organization_v2"
}
...
func (tr *OrganizationV2) GetObservation() (map[string]any, error) {
...
func (tr *OrganizationV2) SetObservation(obs map[string]any) error {
...
func (tr *OrganizationV2) GetParameters() (map[string]any, error) {
...
func (tr *OrganizationV2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this OrganizationV2
func (tr *OrganizationV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrganizationV2
func (tr *OrganizationV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this OrganizationV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OrganizationV2) LateInitialize(attrs []byte) (bool, error) {
	params := &OrganizationV2Parameters{}
