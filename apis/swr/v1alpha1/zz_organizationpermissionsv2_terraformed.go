...
func (mg *OrganizationPermissionsV2) GetTerraformResourceType() string {
	return "opentelekomcloud_swr_organization_permissions_v2"
}
...
func (tr *OrganizationPermissionsV2) GetObservation() (map[string]any, error) {
...
func (tr *OrganizationPermissionsV2) SetObservation(obs map[string]any) error {
...
func (tr *OrganizationPermissionsV2) GetParameters() (map[string]any, error) {
...
func (tr *OrganizationPermissionsV2) SetParameters(params map[string]any) error {
...
// GetInitParameters of this OrganizationPermissionsV2
func (tr *OrganizationPermissionsV2) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrganizationPermissionsV2
func (tr *OrganizationPermissionsV2) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this OrganizationPermissionsV2 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OrganizationPermissionsV2) LateInitialize(attrs []byte) (bool, error) {
	params := &OrganizationPermissionsV2Parameters{}
