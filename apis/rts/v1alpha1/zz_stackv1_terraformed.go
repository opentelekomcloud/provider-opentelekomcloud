...
func (mg *StackV1) GetTerraformResourceType() string {
	return "opentelekomcloud_rts_stack_v1"
}
...
func (tr *StackV1) GetObservation() (map[string]any, error) {
...
func (tr *StackV1) SetObservation(obs map[string]any) error {
...
func (tr *StackV1) GetParameters() (map[string]any, error) {
...
func (tr *StackV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this StackV1
func (tr *StackV1) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StackV1
func (tr *StackV1) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this StackV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *StackV1) LateInitialize(attrs []byte) (bool, error) {
	params := &StackV1Parameters{}
