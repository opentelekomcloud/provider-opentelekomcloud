...
func (mg *SoftwareConfigV1) GetTerraformResourceType() string {
	return "opentelekomcloud_rts_software_config_v1"
}
...
func (tr *SoftwareConfigV1) GetObservation() (map[string]any, error) {
...
func (tr *SoftwareConfigV1) SetObservation(obs map[string]any) error {
...
func (tr *SoftwareConfigV1) GetParameters() (map[string]any, error) {
...
func (tr *SoftwareConfigV1) SetParameters(params map[string]any) error {
...
// GetInitParameters of this SoftwareConfigV1
func (tr *SoftwareConfigV1) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SoftwareConfigV1
func (tr *SoftwareConfigV1) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this SoftwareConfigV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SoftwareConfigV1) LateInitialize(attrs []byte) (bool, error) {
	params := &SoftwareConfigV1Parameters{}
