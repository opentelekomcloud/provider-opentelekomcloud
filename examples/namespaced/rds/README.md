...
subnet, security group, EIP, and password from a Kubernetes secret.
...
|------|-------|-----------|
| `${Rand.RFC1123Subdomain}` | names of VpcV1, SubnetV1, SecgroupV2, EIPV1, InstanceV3 | Replace with a unique RFC1123-compatible suffix (or leave for the example generator to substitute) |
