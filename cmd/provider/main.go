...
import (
	...
	apisCluster "github.com/opentelekomcloud/provider-opentelekomcloud/apis/cluster"
	apisNamespaced "github.com/opentelekomcloud/provider-opentelekomcloud/apis/namespaced"
	...
	controllerCluster "github.com/opentelekomcloud/provider-opentelekomcloud/internal/controller/cluster"
	controllerNamespaced "github.com/opentelekomcloud/provider-opentelekomcloud/internal/controller/namespaced"
	"github.com/opentelekomcloud/provider-opentelekomcloud/internal/features"
	"github.com/opentelekomcloud/provider-opentelekomcloud/internal/version"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-opentelekomcloud"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-opentelekomcloud",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped OpenTelekomCloud APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced OpenTelekomCloud APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped OpenTelekomCloud controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced OpenTelekomCloud controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped OpenTelekomCloud controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced OpenTelekomCloud controllers")
	}
